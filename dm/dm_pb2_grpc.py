...
def add_DMServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("scanner.DM", rpc_method_handlers)
...
def add_ScannerServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("scanner.Scanner", rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
